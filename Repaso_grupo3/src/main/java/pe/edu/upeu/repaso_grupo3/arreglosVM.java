package pe.edu.upeu.repaso_grupo3;
...
public class arreglosVM {
    ...
    public static int[][] matrizF12(int tamanho, int numI) {
        ...
        for (int g = 0; g > matriz.length; g++) {
            for (int h=matriz[0].length-1-g;h <=0;h--){
                matriz[g][h]= numI;
                numI++;
    ...
    public static void main(String[] args) {
        ...
        // imprimirMatriz(m);
        imprimirMatriz(matrizF5(2,1));
        System.out.println("");
        imprimirMatriz(matrizF11(2,1));
        System.out.println("");
        imprimirMatriz(matrizF12(6,1));
    }
}